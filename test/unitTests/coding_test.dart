...
void main() {
  group('Testing status handling of "mergeAndCheckCodings" |', () {
    ...
    test('should set status to "notPersisted"', () {
      ...
      List<Coding> remoteList =
          List.of({Coding(fileName: "CODING--CZ---DATE--2020-05-26.json", lang: "CZ", date: "2020-06-21")});
    ...
    test('should set status to "updateAvailable"', () {
      List<Coding> localList =
          List.of({Coding(fileName: "CODING--CZ---DATE--2020-05-26.json", lang: "CZ", date: "2020-06-20")});
      List<Coding> remoteList =
          List.of({Coding(fileName: "CODING--CZ---DATE--2020-05-26.json", lang: "CZ", date: "2020-06-21")});
  ...
  group('Correct coding file json extraction', () {
    ...
    test('testing replacing of unescaped characters', () {
      ...
      List<CodingEntry> expectedEntries =
          List.of({CodingEntry(char: "¿", ascii: "_ESQM"), CodingEntry(char: "¡", ascii: "_ESRR")});
